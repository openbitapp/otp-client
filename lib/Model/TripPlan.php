 ...
 */
class TripPlan implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TripPlan';
    ...
    protected static $openAPITypes = [
        ...
        'itineraries' => '\OpenBitApp\OTPClient\Model\Itinerary[]'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['itineraries'] === null) {
            $invalidProperties[] = "'itineraries' can't be null";
        }
     ...
     * Gets itineraries
     *
     * @return \OpenBitApp\OTPClient\Model\Itinerary[]
     */
     ...
     * Sets itineraries
     *
     * @param \OpenBitApp\OTPClient\Model\Itinerary[] $itineraries itineraries
     *
     * @return self
     */
