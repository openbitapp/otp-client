...
namespace OpenBitApp\OTPClient;
...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://otp.bitapp.it/v2/otp';
    ...
    {
        $report  = 'PHP SDK (OpenBitApp\OTPClient) Debug Report:' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return [
            [
                "url" => "https://otp.bitapp.it/v2/otp",
